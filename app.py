...
from classes.vbi import Vbi
from classes.jwt import get_token, decode_token
...
with open('db/dummy.json') as config_file:
    config = json.load(config_file)

debug_log = create_logger('debug', 'debug.log')
